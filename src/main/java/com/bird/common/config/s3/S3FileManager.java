...
import com.bird.common.config.aws.AmazonClientProvider;
...
public class S3FileManager {
    ...
    public String uploadArticleImage(String imageName, MultipartFile multipartFile) throws IOException {
        return upload(imageName, multipartFile, ARTICLE_IMAGE_PATH, true);
    }
    ...
    public void deleteArticleImages(String filename) {
        AmazonS3 s3client = getS3Client();
        String keyName = ARTICLE_IMAGE_PATH + filename;
        s3client.deleteObject(new DeleteObjectRequest(bucketName, keyName));
    }
