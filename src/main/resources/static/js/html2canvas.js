    ...
    return function(A) {
            ...
            var n = e.LENGTH_TYPE = {
                ...
                function A(e) {
                    !function(A, e) {
                        ...
                        this.type = "%" === e.substr(e.length - 1) ? n.PERCENTAGE : n.PX;
                    var t = parseFloat(e);
            ...
            var v = ["INPUT", "TEXTAREA", "SELECT"]
                ...
                function A(e, t, r, B) {
                    ...
                    var S = e.ownerDocument.defaultView
                        ...
                        , M = (0,
                        i.parseDisplay)(D.display)
                        , O = "radio" === e.type || "checkbox" === e.type
                        , R = (0,
                        F.parsePosition)(D.position);
                    if (this.style = {
                        background: O ? T.INPUT_BACKGROUND : (0,
                            a.parseBackground)(D, r),
                        border: O ? T.INPUT_BORDERS : (0,
                            s.parseBorder)(D),
                        borderRadius: (e instanceof S.HTMLInputElement || e instanceof HTMLInputElement) && O ? (0,
                            T.getInputBorderRadius)(e) : (0,
                            o.parseBorderRadius)(D),
                        color: O ? T.INPUT_COLOR : new n.default(D.color),
                        display: M,
                        float: (0,
                            c.parseCSSFloat)(D.float),
                        font: (0,
                            l.parseFont)(D),
                        letterSpacing: (0,
                            u.parseLetterSpacing)(D.letterSpacing),
                        listStyle: M === i.DISPLAY.LIST_ITEM ? (0,
                            w.parseListStyle)(D) : null,
                        lineBreak: (0,
                            Q.parseLineBreak)(D.lineBreak),
                        margin: (0,
                            U.parseMargin)(D),
                        opacity: parseFloat(D.opacity),
                        overflow: -1 === v.indexOf(e.tagName) ? (0,
                            g.parseOverflow)(D.overflow) : g.OVERFLOW.HIDDEN,
                        overflowWrap: (0,
                            C.parseOverflowWrap)(D.overflowWrap ? D.overflowWrap : D.wordWrap),
                        padding: (0,
                            d.parsePadding)(D),
                        position: R,
                        textDecoration: (0,
                            f.parseTextDecoration)(D),
                        textShadow: (0,
                            E.parseTextShadow)(D.textShadow),
                        textTransform: (0,
                            h.parseTextTransform)(D.textTransform),
                        transform: (0,
                            H.parseTransform)(D),
                        visibility: (0,
                            p.parseVisibility)(D.visibility),
                        wordBreak: (0,
                            N.parseWordBreak)(D.wordBreak),
                        zIndex: (0,
                            I.parseZIndex)(R !== F.POSITION.STATIC ? D.zIndex : "auto")
                    },
                    ...
                    "IMG" === e.tagName && e.addEventListener("load", function() {
                        y.bounds = (0,
                            K.parseBounds)(e, L, _),
                            y.curvedBounds = (0,
                                K.parseBoundCurves)(y.bounds, y.style.border, y.style.borderRadius)
                    }),
                        this.image = b(e, r),
                        this.bounds = O ? (0,
                            T.reformatInputBounds)((0,
                            K.parseBounds)(e, L, _)) : (0,
                            K.parseBounds)(e, L, _),
                        this.curvedBounds = (0,
                            K.parseBoundCurves)(this.bounds, this.style.border, this.style.borderRadius)
                }
                return r(A, [{
                    key: "getClipPaths",
                    value: function() {
                        var A = this.parent ? this.parent.getClipPaths() : [];
                        return this.style.overflow !== g.OVERFLOW.VISIBLE ? A.concat([(0,
                            K.calculatePaddingBoxPath)(this.curvedBounds)]) : A
                    }
                }, {
                    key: "isInFlow",
                    value: function() {
                    ...
                    value: function() {
                        return !(0,
                            B.contains)(this.style.display, i.DISPLAY.NONE) && this.style.opacity > 0 && this.style.visibility === p.VISIBILITY.VISIBLE
                    }
                }, {
                    ...
                    value: function() {
                        return (0,
                            B.contains)(this.style.display, i.DISPLAY.INLINE) || (0,
                            B.contains)(this.style.display, i.DISPLAY.INLINE_BLOCK) || (0,
                            B.contains)(this.style.display, i.DISPLAY.INLINE_FLEX) || (0,
                            B.contains)(this.style.display, i.DISPLAY.INLINE_GRID) || (0,
                            B.contains)(this.style.display, i.DISPLAY.INLINE_LIST_ITEM) || (0,
                            B.contains)(this.style.display, i.DISPLAY.INLINE_TABLE)
                    }
                }, {
            ...
            var s = e.TextBounds = function A(e, t) {
                ...
                , o = (e.parseTextBounds = function(A, e, t) {
                    for (var r = 0 !== e.style.letterSpacing ? (0,
                        a.toCodePoints)(A).map(function(A) {
                        return (0,
                            a.fromCodePoint)(A)
                    }) : (0,
                        a.breakWords)(A, e), c = r.length, l = t.parentNode ? t.parentNode.ownerDocument.defaultView : null, u = l ? l.pageXOffset : 0, Q = l ? l.pageYOffset : 0, w = [], U = 0, g = 0; g < c; g++) {
                        var C = r[g];
                    ...
                    function(A, e, t) {
                        ...
                        if (B) {
                            ...
                            var a = (0,
                                r.parseBounds)(n, e, t);
                            return n.firstChild && B.replaceChild(n.firstChild, n),
                                a
                        }
        ...
        , function(A, e, t) {
            ...
            e.renderElement = function A(e, t, Q) {
                ...
                return (t.foreignObjectRendering ? s.default.SUPPORT_FOREIGNOBJECT_DRAWING : Promise.resolve(!1)).then(function(s) {
                    return s ? function(A) {
                        return A.inlineFonts(w).then(function() {
                            ...
                            var r = new a.default(A.documentElement)
                                ...
                                , B = n.pageXOffset
                                , s = n.pageYOffset
                                , i = "HTML" === e.tagName || "BODY" === e.tagName ? (0,
                    ...
                    }(new i.DocumentCloner(e,t,Q,!0,A)) : (0,
        ...
        , function(A, e, t) {
            ...
            var o = e.LETTER_NUMBER_MODIFIER = 50
                ...
                , _ = e.BREAK_ALLOWED = "÷"
                , D = e.UnicodeTrie = (0,
                B.createTrieFromBase64)(a.default)
                , M = [H, 36]
                , O = [1, 2, 3, 5]
                , R = [i, 8]
                , P = [E, f]
                ...
                return A.forEach(function(A, B) {
                    ...
                    return r.push(B),
                        31 === a ? t.push("strict" === e ? g : T) : a === b ? t.push(H) : 29 === a ? t.push(H) : 43 === a ? A >= 131072 && A <= 196605 || A >= 196608 && A <= 262141 ? t.push(T) : t.push(H) : void t.push(a)
                }),
                    [r, t, n]
            }
                , k = function(A, e, t, r) {
                ...
                return t.forEach(function(A, e) {
                    r += (0,
                        s.fromCodePoint)(A) + (e >= t.length - 1 ? S : G(t, i, o, e + 1, c))
                }),
                    r
            }
                ,
                ...
                return n(A, [{
                    ...
                    value: function(A) {
                        var e = this
                            ...
                            if (A.childNodes.length && A.childNodes.forEach(function(t) {
                                ...
                                if (t) {
                                    var r = (0,
                                        B.calculateContentBox)(A.bounds, A.style.padding, A.style.border)
                                        , n = "number" == typeof t.width && t.width > 0 ? t.width : r.width
                                        , a = "number" == typeof t.height && t.height > 0 ? t.height : r.height;
                                    n > 0 && a > 0 && e.target.clip([(0,
                                        B.calculatePaddingBoxPath)(A.curvedBounds)], function() {
                    ...
                    value: function(A) {
                        var e = this
                            ...
                            , n = function() {
                            var r = (0,
                                o.calculateBackgroungPaintingArea)(A.curvedBounds, A.style.background.backgroundClip);
                    ...
                    value: function(A, e) {
                        ...
                        if (t) {
                            var r = (0,
                                o.calculateBackgroungPositioningArea)(A.style.background.backgroundOrigin, A.bounds, A.style.padding, A.style.border)
                                , n = (0,
                                o.calculateBackgroundSize)(e, t, r)
                                , B = (0,
                                o.calculateBackgroundPosition)(e.position, n, r)
                                , a = (0,
                                o.calculateBackgroundRepeatPath)(e, B, n, r, A.bounds)
                    ...
                    value: function(A, e) {
                        var t = (0,
                            o.calculateBackgroungPositioningArea)(A.style.background.backgroundOrigin, A.bounds, A.style.padding, A.style.border)
                            , r = (0,
                            o.calculateGradientBackgroundSize)(e, t)
                            , n = (0,
                            o.calculateBackgroundPosition)(e.position, r, t)
                            , s = new B.Bounds(Math.round(t.left + n.x),Math.round(t.top + n.y),r.width,r.height)
                            , i = (0,
                            a.parseGradient)(A, e.source, s);
                        if (i)
                            switch (i.type) {
                    ...
                    value: function(A, e, t) {
                        this.target.drawShape((0,
                            B.parsePathForBorder)(t, e), A.borderColor)
                    }
                }, {
                    key: "renderStack",
                    value: function(A) {
                ...
                return r(A, [{
                    ...
                    value: function(A) {
                        ...
                        if (this.hasResourceInCache(A))
                            return A;
                        if (w(A))
                            return this.cache[A] = g(A, this.options.imageTimeout || 0),
                                A;
                            ...
                            if (!this.isSameOrigin(A)) {
                                if ("string" == typeof this.options.proxy)
                                    return this.cache[A] = (0,
                                        B.Proxy)(A, this.options).then(function(A) {
                    ...
                    value: function(A) {
                        var e = this;
                        return u(A) ? g(A, this.options.imageTimeout || 0) : this.hasResourceInCache(A) ? this.cache[A] : this.isSameOrigin(A) || "string" != typeof this.options.proxy ? this.xhrImage(A) : this.cache[A] = (0,
                            B.Proxy)(A, this.options).then(function(A) {
                            return g(A, e.options.imageTimeout || 0)
                        })
                    }
                    ...
                    value: function(A, e, t) {
                        ...
                        return this.cache[A] = Q(e) && !U(e) ? n.default.SUPPORT_BASE64_DRAWING(e).then(B) : B(!0),
                            A
                    }
                }, {
                    key: "isSameOrigin",
